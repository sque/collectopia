...
DB_Conn::prepare('photo-cleanup-expired', 'DELETE FROM photos WHERE secret IS NOT NULL AND place_id is NULL AND (UNIX_TIMESTAMP(NOW()) - UNIX_TIMESTAMP(created_at)) > ?');
